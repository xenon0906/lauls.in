        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 relative">
          ...
          <div className="col-span-1 lg:col-span-2 flex flex-col md:flex-row bg-white rounded-[3rem] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.06)] overflow-hidden relative z-20 hover:-translate-y-2 transition-transform duration-500 border border-white/60 lg:top-[190px]">
            ...
            <div className="w-full md:w-7/12 relative h-[240px] md:h-auto md:rounded-l-[4rem] overflow-hidden shadow-[-10px_0_20px_rgba(0,0,0,0.04)] z-20">
              <Image src={cloudinary("lauls image/Screenshot 2026-05-12 at 8.21.18 PM.png")} fill sizes="(max-width: 1024px) 100vw, 50vw" placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=" className="object-cover" alt="Industrial Logistics Transport" />
            </div>
          </div>
          ...
          <div className="col-span-1 lg:row-span-2 bg-white rounded-[3rem] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col relative z-20 hover:-translate-y-2 transition-transform duration-500 border border-white/60 h-full min-h-[480px]">
            <div className="h-[280px] lg:h-[360px] relative w-full border-b border-gray-50">
              <Image src={cloudinary("images/products/steel_rounds_stacked.png")} fill sizes="(max-width: 1024px) 100vw, 33vw" placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=" className="object-cover" alt="Stacked Steel Rounds for Manufacturing" />
            </div>
            <div className="p-8 lg:p-10 flex-1 flex flex-col justify-center bg-white relative z-10">
              ...
              <p className="text-gray-600 text-base">Extensive stockyards distributing heavy alloy steel rounds for manufacturing.</p>
            </div>
          </div>
          ...
          <div className="col-span-1 bg-white rounded-[3rem] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col relative z-20 hover:-translate-y-2 transition-transform duration-500 border border-white/60 h-full min-h-[360px]">
            <div className="h-[200px] lg:h-[220px] relative w-full border-b border-gray-50">
              <Image src={cloudinary("images/products/ferro_alloys_raw.png")} fill sizes="(max-width: 1024px) 100vw, 25vw" placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=" className="object-cover" alt="Raw Ferro Alloys Materials" />
            </div>
          ...
          <div className="col-span-1 bg-white rounded-[3rem] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col relative z-20 hover:-translate-y-2 transition-transform duration-500 border border-white/60 h-full min-h-[360px]">
            <div className="h-[200px] lg:h-[220px] relative w-full border-b border-gray-50">
              <Image src={cloudinary("lauls image/image copy 4.png")} fill sizes="(max-width: 1024px) 100vw, 25vw" placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=" className="object-cover" alt="Green Logistics Fleet EV LNG CNG" />
            </div>
            <div className="p-8 flex-1 flex flex-col justify-center bg-white">
              <h3 className="text-xl font-bold text-[#0A1628] mb-2">Green Fleet</h3>
              <p className="text-gray-600 text-sm">Decarbonizing logistics through zero-emission heavy EVs and clean LNG/CNG engines.</p>
            </div>
          </div>
          ...
          <div className="col-span-1 bg-white rounded-[3rem] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.06)] overflow-hidden flex flex-col relative z-20 hover:-translate-y-2 transition-transform duration-500 border border-white/60 h-full min-h-[360px]">
            <div className="h-[200px] lg:h-[220px] relative w-full border-b border-gray-50">
              <Image src={cloudinary("images/products/wire_rods_coils.png")} fill sizes="(max-width: 1024px) 100vw, 25vw" placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=" className="object-cover" alt="High-grade Alloy Steel Wire Rods" />
            </div>
            <div className="p-8 flex-1 flex flex-col justify-center bg-white">
              <h3 className="text-xl font-bold text-[#0A1628] mb-2">Alloy Steel Wire Solutions</h3>
              <p className="text-gray-600 text-sm">High-grade alloy steel wire rods engineered for EV supply chain components.</p>
            </div>
          </div>
