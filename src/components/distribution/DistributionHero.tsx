  ...
  return (
    <section className="relative w-full min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1612660462967-bd1ec1b70176?q=80&w=2070&auto=format&fit=crop")' }}
      >
        ...
        <div className="max-w-3xl">
          ...
          >
             <div className="flex flex-col">
               <div className="text-4xl lg:text-5xl font-display font-black text-white drop-shadow-md">28+</div>
               <div className="text-[#DCA54C] text-[10px] mt-2 uppercase tracking-widest font-bold">Years Experience</div>
             </div>
             
             <div className="flex flex-col border-l border-white/10 pl-8">
               <div className="text-4xl lg:text-5xl font-display font-black text-white drop-shadow-md">500+</div>
               <div className="text-[#DCA54C] text-[10px] mt-2 uppercase tracking-widest font-bold">Global Clients</div>
             </div>
             
             <div className="flex flex-col border-l border-white/10 pl-8">
               <div className="text-4xl lg:text-5xl font-display font-black text-white drop-shadow-md">50K+</div>
